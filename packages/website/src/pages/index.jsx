    ...
    <main className="container">
      ...
      <section className={styles.example} aria-labelledby="opencli-title">
        <div>
          ...
          <p>OpenCLI describes your CLI’s commands, arguments, and flags in JSON or YAML. This is an excerpt from clidoc’s own generated OpenCLI document, including its validate command.</p>
          <p>That shared format connects clidoc to a wider ecosystem of documentation, validation, and code generation tools.</p>
          <div className={styles.actions}>
            <Link to="https://opencli.dev/specification">Read the OpenCLI specification →</Link>
            <Link to="/ecosystem">Explore the ecosystem →</Link>
          </div>
        </div>
        <div className={styles.codeExample}><CodeBlock language="json" title="clidoc.json · excerpt">{openCliSnippet}</CodeBlock></div>
      </section>
