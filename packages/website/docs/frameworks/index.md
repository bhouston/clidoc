...
[GitHub](https://github.com/bhouston/clidoc/tree/main/packages/commander) · [npm](https://www.npmjs.com/package/@clidoc/commander)
...
More information, including supported command features, `mergeDocument`, and `__opencli`, is in the [README](https://www.npmjs.com/package/@clidoc/commander) of the npm module.

## oclif

```sh
npm install @clidoc/oclif @clidoc/core @oclif/core
```

[GitHub](https://github.com/bhouston/clidoc/tree/main/packages/oclif) · [npm](https://www.npmjs.com/package/@clidoc/oclif)
...
More information, including supported command features, `mergeDocument`, and `__opencli`, is in the [README](https://www.npmjs.com/package/@clidoc/oclif) of the npm module.
...
[GitHub](https://github.com/bhouston/clidoc/tree/main/packages/yargs) · [npm](https://www.npmjs.com/package/@clidoc/yargs)
...
More information, including supported command features, `mergeDocument`, and `__opencli`, is in the [README](https://www.npmjs.com/package/@clidoc/yargs) of the npm module.
