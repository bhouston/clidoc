...
Browser smoke test: run `pnpm --filter @clidoc/website test:browser` after `pnpm docs:build` and installing Chromium with `pnpm exec playwright install chromium`.
