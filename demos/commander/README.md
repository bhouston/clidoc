...
Run `pnpm --filter @clidoc/demo-commander build`, then `pnpm --filter @clidoc/demo-commander start greet Ada` to run the command or `pnpm --filter @clidoc/demo-commander start __opencli` to print its OpenCLI document as JSON.
